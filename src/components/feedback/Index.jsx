    ...
    <>
      ...
      <div id='feedback' className='flex mt-7 buh  flex-col items-center bg-[#E3E2DF]'>
        ...
        >
          ...
          />
          {errors.name && (
            <p className='w-50 text-[#ff1f00] font-bold text-sm'>{errors.name.message}</p>
          )}
          ...
          />
          {errors.telephone && (
            <p className='w-50 text-[#ff1f00] font-bold text-sm'>
              Введите номер телефона
            </p>
          )}
          <button
            className='w-[35rem] bg-[#173a9a] mb-10 mt-6 py-3 px-3 rounded-xl text-white  m-auto'
            type='submit'
          >
            Отправить заявку
          </button>
